---
name: "source-command-zcf-git-worktree"
description: "管理 Git worktree，在项目平级的 ../.zcf/项目名/ 目录下创建，支持智能默认、IDE 集成和内容迁移"
---

# source-command-zcf-git-worktree

Use this skill when the user asks to run the migrated source command `zcf-git-worktree`.

## Command Template

# Codex Command: Git Worktree
