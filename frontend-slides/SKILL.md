...
### Beautiful HTML Templates (AGENTS.md) Integration

This skill integrates with the **Beautiful HTML Templates** library at `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\`, which contains 34 distinctive, professionally designed presentation templates. The workflow for using these templates is documented in `AGENTS.md`. When the user's brief calls for a template-driven approach — especially for production decks, brand presentations, or when the user wants a polished starting point — use the AGENTS.md workflow:

1. Read AGENTS.md to understand the template selection and adaptation workflow
2. Read `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\index.json` for template metadata (equivalent to `bold-template-pack/selection-index.json`)
3. Follow AGENTS.md Steps 1–6 for template selection (occasion/mood → 3 candidates → title-slide previews → user picks → full deck → delivery)
4. Use the template's `design.md` as the design recipe (equivalent to the full design system docs described in AGENTS.md)
5. Apply AGENTS.md §3 (preserve / replace / extend) rules when adapting the chosen template

The 34 templates in `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\templates\` correspond to the templates described in AGENTS.md. Each has: `design.md` (full design system doc) and `template.html` (reference implementation with slide layouts).
...
Read [STYLE_PRESETS.md](STYLE_PRESETS.md) for safe preset candidates. If `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\index.json` exists, read that compact index too, but do not read any `design.md` files yet.
...
- Generate 3 previews by default: 1 safe preset from `STYLE_PRESETS.md`, at least 1 bold template from the beautiful-html-templates `index.json`, and 1 wildcard.
...
- After choosing bold template candidate(s), read only those candidate(s)' `template.html` files from `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\templates\<slug>\template.html` to extract the title slide for preview.
- Read its `design.md` for the design system reference. Do not read other templates' `design.md` files until the user picks the final template.
...
**When using Beautiful HTML Templates (AGENTS.md workflow):** Instead of generating custom style previews, read `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\index.json`, pick 3 candidates matching the user's occasion/mood, and build title-slide previews by adapting each candidate's `template.html` per AGENTS.md Step 3. Follow the AGENTS.md "Tone-first matching" rules for selection.
...
If the user selected a bold template from the Beautiful HTML Templates library, read that one template's full `design.md` from `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\templates\<slug>\design.md` before generating. Do not read the other templates. Treat `design.md` as the design recipe:

- Apply AGENTS.md §3 adaptation rules: **preserve** fonts/colors/grid/decorations/nav runtime, **replace** headlines/body copy/names/images/placeholders.
...
| -------------------------------------------------- | -------------------------------------------------------------------- | ------------------------- |
| **AGENTS.md** (beautiful-html-templates)            | Template selection & adaptation workflow: occasion/mood → 3 candidates → previews → user picks → full deck → delivery | Phase 1 (workflow overview), Phase 2 (style selection), Phase 3 (generation) |
| [STYLE_PRESETS.md](STYLE_PRESETS.md)               | 12 curated visual presets with colors, fonts, and signature elements | Phase 2 (style selection) |
| `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\index.json` | Template metadata for candidate selection (34 templates) | Phase 2 (style selection) |
| `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\templates\<slug>\template.html` | Reference implementation for title-slide preview extraction | Phase 2 after shortlisting |
| `D:\CCswitch\skills\beautiful-html-templates-main\beautiful-html-templates-main\templates\<slug>\design.md` | Detailed design-system docs for the selected template only | Phase 3 after user selection |
